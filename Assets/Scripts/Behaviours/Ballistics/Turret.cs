...
public class Turret : MonoBehaviour
{
    ...
    public float remainingReloadTime = 0;           // seconds to the next launch
    public float totalReloadTime = 0;               // seconds between launches
    ...
    {
        canLaunch = false;
        GameManager.Instance.TurretLaunched();
